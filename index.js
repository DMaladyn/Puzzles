...
function check()
{
    if(document.getElementById('slot1').src.includes('empty') == false && document.getElementById('slot2').src.includes('empty') == false && document.getElementById('slot3').src.includes('empty') == false && document.getElementById('slot4').src.includes('empty') == false && document.getElementById('slot5').src.includes('empty') == false && document.getElementById('slot6').src.includes('empty') == false && document.getElementById('slot7').src.includes('empty') == false)
    {
        ...
        if(document.getElementById('slot1').src.includes('words/I') && document.getElementById('slot2').src.includes('words/have') && document.getElementById('slot3').src.includes('words/no') && document.getElementById('slot4').src.includes('words/idea') && document.getElementById('slot5').src.includes('words/what') && document.getElementById('slot6').src.includes('words/Im') && document.getElementById('slot7').src.includes('words/doing'))
        {
            console.log('right')
